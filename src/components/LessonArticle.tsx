    ...
    <article className="max-w-3xl mx-auto">
      ...
      <footer className="mt-12 pt-8 border-t border-border">
        <Button
          onClick={onComplete}
          size="lg"
          className={`w-full md:w-auto px-10 py-6 text-lg font-bold shadow-lg ${
            isCompleted
